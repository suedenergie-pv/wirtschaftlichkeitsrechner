...
(function () {
  ...
  if (C) {
    ...
    flat = {
      ...
      growFoot:         d.ps > 0 ? 'bei ' + ps100 + ' % Strompreissteigerung p.a. · reine Stromersparnis ohne Finanzierung' : 'ohne Strompreissteigerung · reine Stromersparnis ohne Finanzierung',
      yearTableNote:    loanOn
        ? 'Der Gesamtstand startet bei − ' + fe(d.ak + d.zinsenGes) + ' (Anlage ' + fe(d.ak) + ' + Finanzierungszinsen ' + fe(d.zinsenGes) + ') und wird durch die jährliche Stromersparnis getilgt. Ab Break-even erwirtschaftet die Anlage Gewinn.'
        : 'Der Gesamtstand startet bei − ' + fe(d.ak) + ' (Anlagenkosten) und wird durch die jährliche Stromersparnis getilgt. Ab Break-even erwirtschaftet die Anlage Gewinn.',
      ...
      breakEven:        (d.be_plain && d.be_plain <= 30) ? fn(d.be_plain, 0) + ' Jahre' : '>30 Jahre',
      ...
      monthlyDifference:(d.nettoMk >= 0 ? '+ ' : '− ') + fe(Math.abs(d.nettoMk)),
    };
    ...
    nested = {
      ...
      results: {
        ...
        ownUseEur:    ' · ' + fe(d.ersEV_m) + ' / Mon.',
        feedInKwh:    flat.feedIn,
        feedInEur:    ' · ' + fe(d.ersEi_m) + ' / Mon.',
    ...
    flat = {
      ...
      oldMonthlyAvg:    '106,67 €',
      oldMonthlyJahr1:  'Stromkosten ohne PV',
      newMonthly:       '135,54 €',
      newMonthlyJahr:   'inkl. Kreditrate 151,87 € / Mon.',
      orangeNetSub:     'Ersparnis − Kreditrate / Monat',
      growToday:        '122,99 €',
      growY20:          '211,54 €',
      growFoot:         'bei 4,0 % Strompreissteigerung p.a. · reine Stromersparnis ohne Finanzierung',
      yearTableNote:    'Der Gesamtstand startet bei − 18.224,12 € (Anlage 15.000,00 € + Finanzierungszinsen 3.224,12 €) und wird durch die jährliche Stromersparnis getilgt. Ab Break-even erwirtschaftet die Anlage Gewinn.',
    ...
    nested = {
      ...
      results: {
        ...
        ownUseKwh: flat.selfConsumption, ownUseEur: ' · 80,00 € / Mon.',
        feedInKwh: flat.feedIn, feedInEur: ' · 42,99 € / Mon.',
